...
const featureName = 'Checking Account';
...
function ImageSection({selectedGroupFairnessMetric}) {
    const Combinations = featureCombinations_string_combinedvalues[featureName];
    const uniqueValues = uniqueFeatureValues_string_combinedvalues[featureName];
...
export default function CheckingAccountGroupFairnessExploration(){
