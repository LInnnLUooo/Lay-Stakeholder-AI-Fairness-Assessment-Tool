            ...
            <Paper elevation={3} sx={{ width: '86%', backgroundColor: '#f5f5f5', padding: '10px', margin: '10px',borderRadius: '8px' }}>
                <Typography variant="h6" component="div" gutterBottom color="primary"
                 >
                    ...
                    <br/>
                    The AI application is fairness if it has "equal" probability for <strong> Foreign Workers Predicted as Good Credit and Locals Predicted as Good Credit</strong> to have Rated Good Credit.
                   <br/>
                   ...
                   <div style={{ borderRadius: '8px', border: '2px solid #42a5f5', margin:"10px", padding: '10px',display: 'inline-block'  }}>
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginRight: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>Rated Good Credit Foreign Workers</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>Predicted as Good Credit Foreign Workers</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>Rated Good Credit Locals</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>Predicted as Good Credit Locals</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                   ...
                   <br/>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>125</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>125 + 42</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> =0.75 (75%)</span>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>10</td>
                        </tr>
                        <tr>
                    ...
                    <br/>
                    Difference = <strong>female - male</strong> = 0.75 - 0.91 = -0.16 (-16%)
