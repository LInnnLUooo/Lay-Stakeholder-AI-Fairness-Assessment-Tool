// 注意：没有更改变量名，只是把导入的数据 和 图片source 换了。 female：age<25, male:age>=25
...
import {group_predGood_realBad_female_IDs, group_predGood_realBad_male_IDs, group_predGood_realGood_female_IDs, group_predGood_realGood_male_IDs,
  ...
  from '../data/agegroups.js';

// import & set: images + group data 
const goodfemaleImage = '/goodyoung.png';
const badfemaleImage = '/badyoung.png'; // The common image source for 'female'，注意斜杠一定不可以少。有了斜杠，无论路由路径如何变化，都会从绝对路径加载找到图片。否则切换路由使用相对路径，容易找不到。
const goodmaleImage = '/goodold.png';
const badmaleImage = '/badold.png'; 
...
export default function GroupDemographicParityImageAge({ selectedID, handleItemClick }) {
      ...
      padding="3px"> 
          ...
          <Box display="flex" 
            ...
            padding="3px">
                    ...
                    sx={{
                      border: '4px dashed #18C82A'  // 设置为绿色的虚线边框
                        ...
                        <Box display="flex" justifyContent="center" padding="3px" >          
                            ...
                            {/* (2.1)instances：Good Predictions， Real Good Lables*/}
                            <Box  display="flex" height="960px" flex="3" flexDirection="column" padding="6px" marginRight = "3px" alignItems="center" sx={{ border: '2px solid #18C82A' }}>
                                  ...
                                  <ImageList sx={{ width: 450,height: 350}} cols={5} rowHeight={30}>
                            ...
                            <Box  display="flex"  flex="3" flexDirection="column" padding='6px' marginRight = "3px" alignItems="center"  sx={{ border: '2px solid #18C82A' }}>            
                                  ...
                                  <ImageList sx={{ width: 450,height: 230}} cols={5} rowHeight={30}>
                    ...
                    sx={{
                      border: '4px dashed #E75555'  // 设置为红色的虚线边框
                        ...
                        <Box display="flex" justifyContent="center"  padding="3px" >          
                            ...
                            {/* (2.1)instances：Bad Predictions， Real Good Lables*/}
              ...
              {/* 2.2 left part:male GOOD & BAD credictions*/}
                      ...
                      border: '4px dashed #18C82A'  // 设置为绿色的虚线边框
                        ...
                        <Box display="flex" justifyContent="center" padding="3px">          
                            ...
                            <Box  display="flex"  flex="3" flexDirection="column" padding='6px' marginRight = "3px" alignItems="center"  sx={{ border: '2px solid #18C82A' }}>
                                ...
                                <ImageList sx={{ width: 400,height: 900}} cols={10} rowHeight={20}>
                            ...
                            <Box   display="flex"  flex="3" flexDirection="column" padding='6px' marginRight = "3px"  alignItems="center"  sx={{ border: '2px solid #18C82A' }}>
                                ...
                                <ImageList  sx={{ width: 450,height: 800}} cols={5} rowHeight={30}>
            ...
            <Paper elevation={3} sx={{ width: '98%', backgroundColor: '#f5f5f5', padding: '10px', margin: '10px',borderRadius: '8px' }}>
                <Typography  variant="h6" component="div" gutterBottom color="primary"
                 >
                    ...
                    <br/>
                    The AI application is fairness if it has "equal" probability for <strong> Age{"<"}25 and Age{">="}25 </strong> individuals to have good predicted credit.
                   <br/>
                   ...
                   <div style={{ borderRadius: '8px', border: '2px solid #42a5f5', margin:"10px", padding: '10px',display: 'inline-block'  }}>
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginRight: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>Age{'<'}25 Individuals predicted as Good Credit</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>Total Age{'<'}25 Individuals</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                   ...
                   <br/>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>14+8</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>14+8 + 1+2</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> = 0.88 (88%)</span>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>121+35</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>121+35 + 4+15</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> = 0.89 (89%)</span>
                    ...
                    <br/>
                    Difference = <strong>Age{'<'}25 Individuals  -  Age{'>='}25 Individuals</strong> = 0.88 - 0.89 = -0.01 (-1%)
