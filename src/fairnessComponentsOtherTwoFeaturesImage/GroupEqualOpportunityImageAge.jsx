            ...
            <Paper elevation={3} sx={{ width: '86%', backgroundColor: '#f5f5f5', padding: '10px', margin: '10px',borderRadius: '8px' }}>
                <Typography variant="h6" component="div" gutterBottom color="primary"
                 >
                    ...
                    <br/>
                    The AI application is fairness if it has "equal" probability for <strong> Rated Good Credit Age{'<'}25 Individuals and Rated Good Credit Age{'>='}25 Individuals</strong> to have good predicted credit.
                   <br/>
                   ...
                   <div style={{ borderRadius: '8px', border: '2px solid #42a5f5', margin:"10px", padding: '10px',display: 'inline-block'  }}>
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginRight: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>Rated Good Credit Age{'<'}25 Individuals</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                   ...
                   <br/>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>14 + 1</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> =0.93 (93%)</span>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>121 + 4</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> = 0.97 (97%)</span>
                    ...
                    <br/>
                    Difference = <strong>Age{'<'}25 Individuals  -  Age{'>='}25 Individuals</strong> = 0.93 - 0.97 = -0.04 (-4%)
