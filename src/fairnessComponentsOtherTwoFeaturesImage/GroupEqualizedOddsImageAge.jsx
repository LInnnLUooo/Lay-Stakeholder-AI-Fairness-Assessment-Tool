...
export default function GroupEqualizedOddsImageGender({ selectedID, handleItemClick }) {
  ...
  return (
      ...
      padding="3px"> 
          ...
          <Typography variant="h6" component="div" gutterBottom color="primary" sx={{ fontWeight: 'bold' }}>
              Equalized Odds for Group Fairness
          </Typography>
                    ...
                    sx={{
                      border: '4px dashed #18C82A'  // 设置为绿色的虚线边框
                        ...
                        <Box display="flex" justifyContent="center" padding="3px" >          
                            ...
                            <Box  display="flex" height='960px' flex="3" flexDirection="column" padding="6px" marginRight = "3px" alignItems="center"  backgroundColor="#D3EFFE" sx={{ border: '2px solid #18C82A' }}>
         ...
         {/* 3. text exP*/}    
            <Paper elevation={3} sx={{ width: '86%', backgroundColor: '#f5f5f5', padding: '10px', margin: '10px',borderRadius: '8px' }}>
                <Typography variant="h6" component="div" gutterBottom color="primary"
                 >
                    <strong>Equallized Odds Definition: </strong>
                    <br/>
                    The AI application is fairness if <strong>Equal Opportunity</strong> and <strong>Predictive Equality</strong> meet the fairness requirement.
                   <br/>
                   ...
                   <div style={{ borderRadius: '8px', border: '2px solid #42a5f5', margin:"10px", padding: '10px',display: 'inline-block'  }}>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center',fontWeight: 'bold'}}>Yellow Background + Yellow Background</td>
                        </tr>
                      </tbody>
                    </table> 
                    </div>
