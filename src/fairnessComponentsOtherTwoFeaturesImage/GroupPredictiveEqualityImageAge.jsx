                    ...
                    sx={{
                      border: '4px dashed #18C82A'  // 设置为绿色的虚线边框
                        ...
                        <Box display="flex" justifyContent="center" padding="3px" >          
                            ...
                            <Box  display="flex" height='960px' flex="3" flexDirection="column" padding="6px" marginRight = "3px" alignItems="center"  backgroundColor="#CFCFCB" sx={{ border: '2px solid #18C82A' }}>
            ...
            <Paper elevation={3} sx={{ width: '86%', backgroundColor: '#f5f5f5', padding: '10px', margin: '10px',borderRadius: '8px' }}>
                <Typography variant="h6" component="div" gutterBottom color="primary"
                 >
                    ...
                    <br/>
                    The AI application is fairness if it has "equal" probability for <strong> Rated Bad Credit Age{'<'}25 Individuals and Rated Bad Credit Age{'>='}25 Individuals</strong> to have good predicted credit.
                   <br/>
                   ...
                   <div style={{ borderRadius: '8px', border: '2px solid #42a5f5', margin:"10px", padding: '10px',display: 'inline-block'  }}>
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginRight: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>Rated Bad Credit Age{'<'}25 Individuals</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                   ...
                   <br/>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>8</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>8 + 2</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> =0.80 (80%)</span>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>35 + 15</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> = 0.70 (70%)</span>
                    ...
                    <br/>
                    Difference = <strong>Age{'<'}25 Individuals - Age{'>='}25 Individuals</strong> = 0.80 - 0.70 = 0.1 (10%)
