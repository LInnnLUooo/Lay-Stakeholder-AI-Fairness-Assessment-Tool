      ...
      padding="3px"> 
                    ...
                    sx={{
                      border: '4px dashed #18C82A'  // 设置为绿色的虚线边框
                        ...
                        <Box display="flex" justifyContent="center" padding="3px" >          
                            ...
                            <Box  display="flex" height="960px" flex="3" flexDirection="column" padding="6px" marginRight = "3px" alignItems="center" backgroundColor="#FEFDD2" sx={{ border: '2px solid #18C82A' }}>
          ...
          {/* 3. text exP*/}    
            <Paper elevation={3} sx={{ width: '86%', backgroundColor: '#f5f5f5', padding: '10px', margin: '10px',borderRadius: '8px' }}>
                <Typography variant="h6" component="div" gutterBottom color="primary"
                 >
                    <strong>Outcome Test Definition: </strong>
                    <br/>
                    The AI application is fairness if it has "equal" probability for <strong> Age{'<'}25 Individuals Predicted as Good Credit and Age{'>='}25 Individuals Predicted as Good Credit</strong> to have Rated Good Credit.
                   <br/>
                   ...
                   <div style={{ borderRadius: '8px', border: '2px solid #42a5f5', margin:"10px", padding: '10px',display: 'inline-block'  }}>
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginRight: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>Rated Good Credit Age{'<'}25 Individuals</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>Predicted as Good Credit Age{'<'}25 Individuals</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                   ...
                   <br/>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>14</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>14 + 8</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> =0.64 (64%)</span>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>121</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>121 + 35</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> = 0.78 (78%)</span>
                    ...
                    <br/>
                    Difference = <strong>Age{'<'}25 Individuals - Age{'>='}25 Individuals</strong> = 0.64 - 0.78 = -0.14 (-14%)
