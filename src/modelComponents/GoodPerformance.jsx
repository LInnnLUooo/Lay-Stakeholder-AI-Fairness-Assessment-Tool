...
const data = [
  { value: 131, label: 'Correct Predictions', p: "94%" ,color: '#81C784'  }, // 可以随意扩展data的属性, color直接对应成颜色
...
export default function PieArcLabel() { // 此处函数的命名 可以与jsx文件名不同。在其他文件调用该jsx文件的时候，对应的import ”自定义名称“ 就代表了此处的 export default function。 但是建议保持命名的一致
  return (
