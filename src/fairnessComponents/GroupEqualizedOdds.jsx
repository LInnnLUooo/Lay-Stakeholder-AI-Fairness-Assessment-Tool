...
//nevigate path：
const EOsIMAGE_AGE_PATH = "/explanationAge/EOsimage";

export default function GroupEqualizedOddsGender() {
    const navigate = useNavigate(); 
    // Scatter Plot 
    const [data] = useState([-4,10,10])
    const svgRef = useRef();
  ...
  return (
    <Box display="flex" flexDirection="column" alignItems="center" width = {500}> 
        ...
        <Typography variant="body2" color="text.secondary" sx={{ margin: "12px",color: "black", fontWeight: "bold"}}>
            ...
            <br />
            The difference between females and males is: <span style={{ color: '#1976D2' }}>10%</span>.
        </Typography>
        ...
        <Box 
            ...
            alignItems="center" 
            marginTop='116px' > 
             <Button variant="contained" size="small" startIcon={<TouchAppIcon />} onClick={() => navigate(EOsIMAGE_AGE_PATH)}>Check individual instances</Button>
        </Box>
