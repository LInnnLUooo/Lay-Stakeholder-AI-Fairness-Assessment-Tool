...
//group8: Bad predictions & real bad & Male
            ...
            <Paper elevation={3} sx={{ width: '86%', backgroundColor: '#f5f5f5', padding: '10px', margin: '10px',borderRadius: '8px' }}>
                <Typography variant="h6" component="div" gutterBottom color="primary"
                 >
                    ...
                    <br/>
                    The AI application is fairness if it has "equal" probability for <strong> females Predicted as Good Credit and males Predicted as Good Credit</strong> to have Rated Good Credit.
                   <br/>
                   ...
                   <div style={{ borderRadius: '8px', border: '2px solid #42a5f5', margin:"10px", padding: '10px',display: 'inline-block'  }}>
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginRight: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>Rated Good Credit Females</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>Predicted as Good Credit Females</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>Rated Good Credit Males</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>Predicted as Good Credit Males</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                   ...
                   <br/>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>27 + 16</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> =0.63 (63%)</span>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>108 + 27</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> = 0.80 (80%)</span>
                    ...
                    <br/>
                    Difference = <strong>female - male</strong> = 0.63 - 0.80 = -0.17 (-17%)
