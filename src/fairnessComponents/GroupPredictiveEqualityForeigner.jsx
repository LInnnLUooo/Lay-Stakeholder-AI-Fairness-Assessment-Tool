...
//nevigate path：
const PEIMAGE_FOREIGNER_PATH = "/explanationForeigner/PEimage";

export default function GroupPredictiveEqualityForeigner() {
    const navigate = useNavigate(); 
    // Scatter Plot 
    const [data] = useState([72,50,22])
    const svgRef = useRef();
  ...
  return (
    <Box display="flex" flexDirection="column" alignItems="center" width = {500}> 
        ...
        <Box display="flex" justifyContent="space-between" width="100%">
            ...
            <Tooltip 
                title={
                    ...
                    >
                    The AI application is fairness if it has "equal" probability for Rated Bad Credit foreign workers and Rated Bad Credit locals to have good predicted credit.
                    </span>
                } 
                placement="left"
                >    
        ...
        <Typography variant="body2" color="text.secondary" sx={{ margin: "12px",color: "black", fontWeight: "bold"}}>
            Of the <span style={{textDecoration: 'underline' }}>foreign workers with Rated Bad Credit</span>, <span style={{ color: '#1976D2' }}>72%</span> are predicted as <span style={{textDecoration: 'underline' }}>Good Credit</span>.
            <br />
            Of the <span style={{textDecoration: 'underline' }}>locals with Rated Bad Credit</span>, <span style={{ color: '#1976D2' }}>50%</span> are predicted as <span style={{textDecoration: 'underline' }}>Good Credit</span>.
            <br />
        ...
        display="flex"
        alignItems="center"  > 
             <Button variant="contained" size="small" startIcon={<TouchAppIcon />} onClick={() => navigate(PEIMAGE_FOREIGNER_PATH)}>Check individual instances</Button>
        </Box>
