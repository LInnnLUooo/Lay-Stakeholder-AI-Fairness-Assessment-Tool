...
const EOIMAGE_FOREIGNER_PATH = "/explanationForeigner/EOimage";

export default function GroupEqualOpportunityForeigner() {
    const navigate = useNavigate(); 
    const [data] = useState([96,99.999,-4])
    const svgRef = useRef();
  ...
  return (
    <Box display="flex" flexDirection="column" alignItems="center" width = {500}> 
        ...
        <Box display="flex" justifyContent="space-between" width="100%">
            ...
            <Tooltip 
                title={
                    ...
                    >
                    The AI application is fairness if it has "equal" probability for Rated Good Credit foreign workers and Rated Good Credit locals to have good predicted credit.
                    </span>
                } 
                placement="left"
                >    
        ...
        <Typography variant="body2" color="text.secondary" sx={{ margin: "12px",color: "black", fontWeight: "bold"}}>
            Of the <span style={{textDecoration: 'underline' }}>foreign workers with Rated Good Credit</span>, <span style={{ color: '#1976D2' }}>96%</span> are predicted as <span style={{textDecoration: 'underline' }}>Good Credit</span>.
            <br />
            Of the <span style={{textDecoration: 'underline' }}>locals with Rated Good Credit</span>, <span style={{ color: '#1976D2' }}>100%</span> are predicted as <span style={{textDecoration: 'underline' }}>Good Credit</span>.
            <br />
            The difference between foreign workers and locals is <span style={{ color: '#1976D2' }}>-4%</span>.
            </Typography>
        ...
        alignItems="center" 
          > 
             <Button variant="contained" size="small" startIcon={<TouchAppIcon />} onClick={() => navigate(EOIMAGE_FOREIGNER_PATH)}>Check individual instances</Button>
        </Box>
