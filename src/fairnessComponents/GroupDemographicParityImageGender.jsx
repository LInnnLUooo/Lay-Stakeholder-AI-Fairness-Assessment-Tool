...
import {group_predGood_realBad_female, group_predGood_realBad_male, group_predGood_realGood_female, group_predGood_realGood_male,
...
export default function GroupDemographicParityImageGender({ selectedID, handleItemClick }) {
            ...
            <Paper elevation={3} sx={{ width: '98%', backgroundColor: '#f5f5f5', padding: '10px', margin: '10px',borderRadius: '8px' }}>
                <Typography  variant="h6" component="div" gutterBottom color="primary"
                 >
                    ...
                    <br/>
                    The AI application is fairness if it has "equal" probability for <strong> female and male</strong> applicants to have good predicted credit.
                   <br/>
                   ...
                   <div style={{ borderRadius: '8px', border: '2px solid #42a5f5', margin:"10px", padding: '10px',display: 'inline-block'  }}>
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginRight: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>Total Females</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>Total Males</td>
                        </tr>
                      </tbody>
                    </table>
                    =
                   ...
                   <br/>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>27+16</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>27+16 + 4+6</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> = 0.81 (81%)</span>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>108+27</td>
                        </tr>
                        <tr>
                          <td style={{ textAlign: 'center' }}>108+27 + 1+11</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> = 0.92 (92%)</span>
                    ...
                    <br/>
                    Difference = <strong>female - male</strong> = 0.81 - 0.92 = -0.11 (11%)
