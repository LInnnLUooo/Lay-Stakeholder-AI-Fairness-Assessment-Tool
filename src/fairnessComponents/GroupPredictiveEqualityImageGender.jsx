            ...
            <Paper elevation={3} sx={{ width: '86%', backgroundColor: '#f5f5f5', padding: '10px', margin: '10px',borderRadius: '8px' }}>
                <Typography variant="h6" component="div" gutterBottom color="primary"
                 >
                    ...
                    <br/>
                    The AI application is fairness if it has "equal" probability for <strong> Rated Bad Credit males and Rated Bad Credit females</strong> to have good predicted credit.
                   <br/>
                   ...
                   <br/>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        <tr>
                          <td style={{ borderBottom: '1px solid black', textAlign: 'center' }}>16</td>
                        </tr>
                        <tr>
                    ...
                    <table style={{ display: 'inline', verticalAlign: 'middle', marginLeft: '10px' }}>
                      <tbody>
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>27 + 11</td>
                        </tr>
                      </tbody>
                    </table>                                 
                    <span> = 0.71 (71%)</span>
                    ...
                    <br/>
                    Difference = <strong>female - male</strong> = 0.73 - 0.71 = 0.02 (2%)
