  ...
  return (
    <Box display="flex" flexDirection="column" alignItems="center" width = {500}> 
        ...
        <Box display="flex" justifyContent="space-between" width="100%">
            ...
            {/* <Tooltip title={'The AI application is fairness if it has "equal" probability for age<25 and age>=25 individuals to have good predicted credit.'} placement="left"> */}
             <Tooltip 
                title={
                    <span 
                    style={{ 
