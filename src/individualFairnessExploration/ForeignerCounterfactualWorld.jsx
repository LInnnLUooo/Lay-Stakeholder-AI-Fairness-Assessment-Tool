...
export default function ForeignerCounterfactualWorld (){
          ...
          <PieChart
            ...
            <Paper elevation={3} sx={{ width: '75%', backgroundColor: '#f5f5f5', padding: '10px', margin: '20px',borderRadius: '8px' }}>
              <Typography variant="h6" color="text.secondary" sx={{ margin: "12px",color: "black", width: '95%', fontWeight: "bold"}}>
                ...
                changing their <span style={{textDecoration: 'underline' }}> foreign worker status from {'Yes'} to {'No'}, or vice versa, </span>          
                does not change the predicted credit result. 
                However, <span style={{ color: '#1976D2' }}>2.5% (5 individuals)</span> do not conform. When the foreign worker status attribute is reversed, <span style={{ color: '#1976D2' }}>the predicted outcome changes</span>.
              </Typography>
            </Paper>
